...
var async, db, defaultPermissions, getLostBinaries, initTokens, log, permissionsManager, request, thumb;
...
getLostBinaries = exports.getLostBinaries = function(callback) {
  var lostBinaries;
  lostBinaries = [];
  return request.viewAll('binary', function(err, binaries) {
...
exports.addAccesses = function(callback) {
  ...
  addAccess = function(docType, cb) {
    return request.viewAll(docType, function(err, apps) {
...
exports.removeDocWithoutDocType = function(callback) {
  return db.view('all/withoutdoctype', function(err, docs) {
    if (err) {
      return callback(err);
